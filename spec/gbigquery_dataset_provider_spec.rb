...
describe Puppet::Type.type(:gbigquery_dataset).provider(:google) do
  before(:all) do
          ...
          context 'title == name (pass)' do
            ...
            let(:catalog) do
              apply_with_error_check(
                <<-MANIFEST
                gbigquery_dataset { 'title0':
                  ensure                      => present,
                  access                      => [
                    {
                      domain         => 'test domain#0 data',
                      group_by_email => 'test group_by_email#0 data',
                      role           => 'READER',
                      special_group  => 'test special_group#0 data',
                      user_by_email  => 'test user_by_email#0 data',
                      view           => {
                    ...
                    },
                    {
                      ...
                      group_by_email => 'test group_by_email#1 data',
                      role           => 'WRITER',
                      special_group  => 'test special_group#1 data',
                      user_by_email  => 'test user_by_email#1 data',
                      view           => {
                    ...
                    },
                    {
                      ...
                      group_by_email => 'test group_by_email#2 data',
                      role           => 'OWNER',
                      special_group  => 'test special_group#2 data',
                      user_by_email  => 'test user_by_email#2 data',
                      view           => {
                  ...
                  default_table_expiration_ms => 1786720217,
                ...
                gbigquery_dataset { 'title1':
                  ...
                  access                      => [
                    ...
                    },
                    {
                      ...
                      group_by_email => 'test group_by_email#3 data',
                      role           => 'READER',
                      special_group  => 'test special_group#3 data',
                      user_by_email  => 'test user_by_email#3 data',
                      view           => {
                        dataset_id => 'test dataset_id#3 data',
                        table_id   => 'test table_id#3 data',
                        project_id => 'test project_id#3 data',
                      },
                    },
                    {
                      domain         => 'test domain#4 data',
                      group_by_email => 'test group_by_email#4 data',
                      role           => 'WRITER',
                      special_group  => 'test special_group#4 data',
                      user_by_email  => 'test user_by_email#4 data',
                      view           => {
                        dataset_id => 'test dataset_id#4 data',
                        table_id   => 'test table_id#4 data',
                        project_id => 'test project_id#4 data',
                      },
                    },
                    {
                      domain         => 'test domain#5 data',
                      group_by_email => 'test group_by_email#5 data',
                      role           => 'OWNER',
                      special_group  => 'test special_group#5 data',
                      user_by_email  => 'test user_by_email#5 data',
                      view           => {
                        dataset_id => 'test dataset_id#5 data',
                        table_id   => 'test table_id#5 data',
                        project_id => 'test project_id#5 data',
                      },
                    },
                  ],
                  dataset_reference           => {
                  ...
                  default_table_expiration_ms => 3573440435,
                ...
                gbigquery_dataset { 'title2':
                  ...
                  default_table_expiration_ms => 5360160653,
            ...
            context 'Gbigquery_dataset[title0]' do
              subject do
            ...
            context 'Gbigquery_dataset[title1]' do
              subject do
            ...
            context 'Gbigquery_dataset[title2]' do
              subject do
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gbigquery_dataset[title0]').provider.ensure
          end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gbigquery_dataset[title0]')
              .provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gbigquery_dataset).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
  ...
  def expect_network_create(id, expected_body, data = {})
    ...
    body = { kind: 'bigquery#dataset' }.to_json
  ...
  def expand_variables(template, data, extra_data = {})
    Puppet::Type.type(:gbigquery_dataset).provider(:google)
